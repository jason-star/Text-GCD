...
if __name__ == "__main__":
    ...
    if args.dataset == 'cifar10':
        ...
        train_dataset = CustomCIFAR100(root=cifar_100_root, train=True, download=True, transform=val_transform)
        test_dataset = CustomCIFAR100(root=cifar_100_root, train=False, download=True, transform=val_transform)
        targets = list(set(train_dataset.targets))
